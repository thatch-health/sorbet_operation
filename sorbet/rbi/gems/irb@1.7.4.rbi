...
class IRB::Context
  ...
  #
  # source://irb//lib/irb/context.rb#353
  ...
  #
  # source://irb//lib/irb/context.rb#356
  ...
  #     # omg
  #
  # source://irb//lib/irb/context.rb#291
  def echo; end
  ...
  #
  # source://irb//lib/irb/context.rb#326
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/context.rb#442
  def file_input?; end
  ...
  # source://irb//lib/irb/context.rb#546
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/context.rb#436
  def inspect?; end

  # source://irb//lib/irb/context.rb#529
  ...
  # See IRB@Command+line+options for more command line options.
  #
  # source://irb//lib/irb/context.rb#459
  ...
  #
  # source://irb//lib/irb/context.rb#196
  def io; end
  ...
  # source://irb//lib/irb/context.rb#568
  def local_variables; end

  # The top-level workspace, see WorkSpace#main
  #
  # source://irb//lib/irb/context.rb#181
  def main; end
  ...
  # See IRB@Customizing+the+IRB+Prompt for more information.
  #
  # source://irb//lib/irb/context.rb#419
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/context.rb#400
  def prompting?; end
  ...
  #
  # source://irb//lib/irb/context.rb#263
  ...
  # to #last_value.
  #
  # source://irb//lib/irb/context.rb#411
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/context.rb#573
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/context.rb#579
  ...
  #
  # source://irb//lib/irb/context.rb#224
  ...
  #
  # source://irb//lib/irb/context.rb#344
  def verbose; end
  ...
  #
  # source://irb//lib/irb/context.rb#188
  def workspace; end
...
# source://irb//lib/irb/context.rb#541
...
class IRB::FileInputMethod < ::IRB::InputMethod
  ...
  # source://irb//lib/irb/input-method.rb#169
  def close; end

  # The external encoding for standard input.
  #
  # source://irb//lib/irb/input-method.rb#160
  def encoding; end
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#147
  def eof?; end

  # The file name of this input method, usually given during initialization.
  #
  # source://irb//lib/irb/input-method.rb#141
  def file_name; end
  ...
  #
  # source://irb//lib/irb/input-method.rb#154
  def gets; end
  ...
  class << self
    # source://irb//lib/irb/input-method.rb#124
...
module IRB::HistorySavingAbility
  ...
  # source://irb//lib/irb/history.rb#32
  def save_history; end
...
class IRB::InputMethod
  ...
  # For debug message
  #
  # source://irb//lib/irb/input-method.rb#54
  def inspect; end
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#49
...
class IRB::ReadlineInputMethod < ::IRB::InputMethod
  # source://irb//lib/irb/input-method.rb#184
  def initialize; end

  # source://irb//lib/irb/input-method.rb#250
  def encoding; end

  # source://irb//lib/irb/input-method.rb#224
  def eof?; end

  # source://irb//lib/irb/input-method.rb#208
  def gets; end

  # source://irb//lib/irb/input-method.rb#255
  def inspect; end

  # source://irb//lib/irb/input-method.rb#245
  def line(line_no); end

  # source://irb//lib/irb/input-method.rb#232
  def readable_after_eof?; end

  # source://irb//lib/irb/input-method.rb#236
  def support_history_saving?; end

  class << self
    # source://irb//lib/irb/input-method.rb#176
...
# source://irb//lib/irb/input-method.rb#265
...
# source://irb//lib/irb/input-method.rb#319
...
# source://irb//lib/irb/input-method.rb#60
class IRB::StdioInputMethod < ::IRB::InputMethod
  # Creates a new input method object
  #
  # @return [StdioInputMethod] a new instance of StdioInputMethod
  #
  # source://irb//lib/irb/input-method.rb#61
  def initialize; end

  # The external encoding for standard input.
  #
  # source://irb//lib/irb/input-method.rb#111
  def encoding; end
  ...
  # @return [Boolean]
  #
  # source://irb//lib/irb/input-method.rb#82
  def eof?; end
  ...
  # See IO#gets for more information.
  #
  # source://irb//lib/irb/input-method.rb#72
  def gets; end

  # For debug message
  #
  # source://irb//lib/irb/input-method.rb#116
  def inspect; end
  ...
  # See IO#lineno for more information.
  #
  # source://irb//lib/irb/input-method.rb#106
  def line(line_no); end
